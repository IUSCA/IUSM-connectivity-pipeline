...
export PARC0dir="MNI_templates/MNI152_T1_1mm_VentricleMask.nii.gz"
export PARC0pcort=0;
...
export flag_ANTS=false # other option available is FSL's SUSAN, set flag_ANTS=false to use SUSAN instead 
if ${flag_ANTS}; then 
...
if $T1_PREPARE_B; then
	...
	export path2MNIref="${path2MNIparcs}/MNI_templates/MNI152_T1_1mm.nii.gz"
...
if $fMRI_A; then
	...
	export flags_EPI_MotionRegressors=true
