...
flags.EPI.SpinEchoUnwarp = 1; % Requires UNWARP directory and approporiate dicoms.
    ...
    % readOutTime is now calculated from image data.
...
flags.EPI.AROMA = 1; % ICA-based denoising; WARNING: This will smooth your data.
flags.EPI.DemeanDetrend = 0;
flags.EPI.MotionRegressors = 0;
...
flags.EPI.SpatialSmooth = 0;% The current kernel is zero, because data is reduced to ROI level.
