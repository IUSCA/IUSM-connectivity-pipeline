...
flags.T1.bet = 1; % brain extraction and mask generation
    configs.T1.antsTemplate = 'NKI'; % 'MICCAI' or 'NKI'
...
flags.T1.reg2MNI=1;
    ...
    configs.T1.useMNIbrain=0; % use MNI152T1_brain (=1) rather than MNI152T1 (=0)
...
flags.T1.seg = 1;
    ...
    configs.T1.flirtdof6cost = 'corratio'; % 'corratio'-fsl default; 'mutualinfo'-recommended 
flags.T1.parc=1;
...
flags.EPI.Regressors = 1; %physiological regressors (WM,CSF)
    configs.EPI.GS = 1; % global signal regression
