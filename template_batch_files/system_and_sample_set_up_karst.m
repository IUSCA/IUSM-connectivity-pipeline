...
paths.scripts = '/N/dc2/projects/connectivitypipeline/connectivity-pipeline-beta/connectome_scripts-beta';
...
paths.FSL = '/N/soft/rhel6/fsl/5.0.10/bin';
    % FSL setup
FSLsetup = 'FSLDIR=/N/soft/rhel6/fsl/5.0.10; . ${FSLDIR}/etc/fslconf/fsl.sh; PATH=${FSLDIR}/bin:${PATH}; export FSLDIR PATH';
    % Path to AFNI
paths.AFNI = '/N/soft/rhel6/afni/16.3.00';
    % Path to MRIcroGL
...
paths.data = '/N/dc2/scratch/jdwest/connectivity_pipeline_beta_test/testdata';
